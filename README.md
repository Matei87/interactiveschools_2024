...
- Hero Area
  ...
  ```sh
  - you need to use the following collection: https://gist.github.com/danielmtd/4027925144b88e175b53bd0f127f1052
   ...
   - on desktop it should horizontally scroll and pin ( these means that the hero are needs to be fixed during the scrolling and unfix when its at the end. Check the examples). Use gsap with scrolltrigger.
  ```
...
- Rotator
  ...
  ```sh
    Its formed by 2 parts side by side. The right part freely scroll, the left part sticks when the center of the viewport hits the first item and unstick when the center of the viewport hits the last item
